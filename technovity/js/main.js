...
// Get the .left-side-icon element
var leftSideIcon = document.querySelector('.left-side-icon');

// Add event listener for a specific event (e.g., button click)
document.getElementById('toggleButton').addEventListener('click', function() {
  // Toggle the 'visible' class to show/hide the icon
  leftSideIcon.classList.toggle('visible');
});
